  ...
  (props, ref) => {
    ...
    const handleChange = (event: any) => {
      ...
      if (newValue.startsWith(" ")) {
        // If the value starts with a space, remove it
        newValue = newValue.trimStart();
      } else {
        // Otherwise, replace multiple internal spaces with a single space
        newValue = newValue.replace(/\s\s+/g, " ");
      }

      // Call any existing onChange handler from the inputProps
      ...
      // Call any additional onChange handler from props
      if (props.onChange) {
        props.onChange({
          ...event,
          target: {
    ...
    const adjustedInputProps = {
      ...inputProps, // get existing inputProps
      onChange: handleChange, // Override or add the onChange handler
    };
