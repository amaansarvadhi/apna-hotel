...
export interface ButtonProps
  ...
  variant?: "solid" | "twoTone" | "plain" | "default" | "lightGray";
}
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const twoToneColor = () => {
    const btn = {
      bgColor: active
        ? `bg-${buttonColor}-300 dark:bg-${buttonColor}-100`
        : `bg-${buttonColor}-100 dark:bg-${buttonColor}-500 dark:bg-opacity-10`,
      textColor: `text-${buttonColor}-${buttonColorLevel} dark:text-${buttonColor}-50`,
      hoverColor: active
        ? ""
        : `hover:bg-${buttonColor}-200 dark:hover:bg-${buttonColor}-500 dark:hover:bg-opacity-30`,
      activeColor: `active:bg-${buttonColor}-200 dark:active:bg-${buttonColor}-500 dark:active:bg-opacity-30`,
    };
    return getBtnColor(btn);
  };
