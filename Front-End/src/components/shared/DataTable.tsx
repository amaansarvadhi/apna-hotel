  ...
  return (
    <Loading loading={loading && data.length !== 0} type="cover">
      <Table className="rounded-lg">
        <THead
          className="bg-[#F3F2F8] sticky-header !rounded-lg whitespace-nowrap"
                      ...
                      <div
                        className={classNames(
                          header.column.getCanSort() &&
                            "cursor-pointer select-none point whitespace-nowrap",
                          loading && "pointer-events-none whitespace-nowrap",
                        )}
                  ...
                  <Tr key={row.id} className="!p-0">
                    {row.getVisibleCells().map((cell) => {
                      return (
                        <Td
                          key={cell.id}
                          className="!py-0 whitespace-nowrap text-center"
                        >
                          {flexRender(
